# Codev_Tim — Product Registry (Canonical)

**Document ID:** `CT-DOC-09`  
**Version:** 1.0.0  
...
Canonical list of all registered products for the Product Registry module. Source of truth for slugs, status, and metadata. Full profile context: `03_ABOUT_TIMUR.md` §7.
...
| 4   | `codev-tim`             | Codev_Tim                   | In Development | —                     | [Codev_Tim_site](https://github.com/WinstonSalemm/Codev_Tim_site)                                                                           |
| 5   | `assistant-agent`       | Codev Assistant             | Experimental   | `ai-integration`      | [AssistantAgent](https://github.com/WinstonSalemm/AssistantAgent)                                                                           |
...
## Scheduled (Not Yet in Registry UI)
